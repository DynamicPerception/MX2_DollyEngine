...
PROGMEM const char *man_str[]   = { manual_menu_1, manual_menu_2 };
...
PROGMEM const char *set_str[]   = { set_menu_1, set_menu_2, set_menu_3, set_menu_4, set_menu_5, set_menu_6, set_menu_7, set_menu_8, set_menu_9 };

 // max number of inputs for each menu (in order listed above, starting w/ 0)
byte max_menu[7]  = {4,1,7,7,5,8};
...
void main_loop_handler() {
  ...
  static bool camera_fired = false;
  static bool motors_clear = false;
